...
class Rakuun_Intern_Production_Building_Airport extends Rakuun_Intern_Production_Building {
	...
	public function __construct(DB_Record $dataSource = null) {
		...
		$this->setLongDescription('Flughäfen werden für die Konstruktion von Gleitern benötigt.
			...
			<br/>
			Nur eine kleine Schar von Leuten wird dann wirklich als Pilot akzeptiert. Eines guten Piloten bedarf es nicht nur gute Reflexe und eines ausgeprägten Orientierungssinns, er muss auch nach stundenlangem Flug noch völlig konzentriert sein und auch psychologisch der Aufgabe gewachsen sein.
			<br/>
			...
			<br/>
			Nur wer sich dann nach ewig langem Training bewährt hat, darf die Gerüste erklimmen und im Cockpit eines echten Kampfgleiters sitzen um seinen ersten Einsatz durchzuführen.');
		$this->setPoints(8);
	}
