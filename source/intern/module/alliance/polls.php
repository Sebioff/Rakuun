...
class Rakuun_Intern_Module_Alliance_Polls extends Rakuun_Intern_Module implements Scriptlet_Privileged {
	public function init() {
		...
		$this->contentPanel->addPanel(new Rakuun_GUI_Panel_Box_Collapsible('pollsbox', new Rakuun_Intern_GUI_Panel_Polls('polls', Rakuun_Intern_GUI_Panel_Polls::POLL_ALLIANCE), 'Umfragen'));
	}
