...
class Rakuun_Intern_Production_Building_StockMarket extends Rakuun_Intern_Production_Building {
	...
	public function __construct(DB_Record $dataSource = null) {
		...
		$this->setShortDescription('Die Börse - ein großer Umschlagplatz für Eisen, Beryllium und Energie.<br />Durch den Ausbau werden die Umtauschkosten gesenkt, sowie die maximale tägliche umtauschbare Ressourcenmenge erhöht.');
