...
class Rakuun_Intern_GUI_Panel_Meta_Profile_Own extends GUI_Panel {
	public function init() {
		...
		$meta = Rakuun_DB_Containers::getMetasContainer()->selectByIdFirst($user->alliance->meta);
		...
		$this->addPanel(new Rakuun_GUI_Panel_Box('shoutbox', new Rakuun_Intern_GUI_Panel_Shoutbox_Meta('shouts', $meta), 'Shoutbox'));
