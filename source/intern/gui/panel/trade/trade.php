...
class Rakuun_Intern_GUI_Panel_Trade extends GUI_Panel {
	...
	public function onSubmit() {
		...
		if ($this->status->getValue() == self::IDLE) {
			...
			Rakuun_Intern_Log_Ressourcetransfer::log($recipient, Rakuun_Intern_Log::ACTION_RESSOURCES_TRADE, $sender, $this->iron->getValue(), $this->beryllium->getValue(), $this->energy->getValue(), $this->people->getValue());
