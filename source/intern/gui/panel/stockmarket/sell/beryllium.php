...
class Rakuun_Intern_GUI_Panel_StockMarket_Sell_Beryllium extends Rakuun_Intern_GUI_Panel_StockMarket {
	public function init() {
		...
		$factor = new GUI_Panel_Number('sell_beryllium_iron', 1 / $this->calculateStockExchangePrice($ressources[parent::RESSOURCE_BERYLLIUM], $ressources[parent::RESSOURCE_IRON]));
		$this->first->setTitle('Eisen (* '.$factor->render().')');
		$factor = new GUI_Panel_Number('sell_beryllium_energy', 1 / $this->calculateStockExchangePrice($ressources[parent::RESSOURCE_BERYLLIUM], $ressources[parent::RESSOURCE_ENERGY]));
