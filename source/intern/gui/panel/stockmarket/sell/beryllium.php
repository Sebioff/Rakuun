...
class Rakuun_Intern_GUI_Panel_StockMarket_Sell_Beryllium extends Rakuun_Intern_GUI_Panel_StockMarket_Sell {
	public function init() {
		parent::init();
		
		$this->addPanel(new GUI_Control_DigitBox('amount', 0, 'Menge', 0, self::getTradable()));
		$factor = new GUI_Panel_Number('sell_beryllium_iron', 1 / $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_IRON, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_BERYLLIUM));
		...
		$factor = new GUI_Panel_Number('sell_beryllium_energy', 1 / $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_ENERGY, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_BERYLLIUM));
