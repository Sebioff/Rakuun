...
class Rakuun_Intern_GUI_Panel_StockMarket_Sell_Beryllium extends Rakuun_Intern_GUI_Panel_StockMarket {
	...
	public function init() {
		...
		$factor = new GUI_Panel_Number('sell_beryllium_iron', $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_BERYLLIUM, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_IRON));
		...
		$factor = new GUI_Panel_Number('sell_beryllium_energy', $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_BERYLLIUM, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_ENERGY));
