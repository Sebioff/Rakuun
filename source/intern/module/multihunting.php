...
class Rakuun_Intern_Module_Multihunting extends Rakuun_Intern_Module implements Scriptlet_Privileged {
	public function init() {
		...
		$this->contentPanel->addPanel(new Rakuun_GUI_Panel_Box('ressource', new Rakuun_Intern_GUI_Panel_Multihunting_RessourceLog('ressource', $user, 'eingehender Ressourcen-Transfer'), 'eingehender Ressourcen-Transfer'));
		...
		$this->contentPanel->addPanel(new Rakuun_GUI_Panel_Box('ressourceout', new Rakuun_Intern_GUI_Panel_Multihunting_RessourceOutLog('ressourceout', $user, 'ausgehender Ressourcen-Transfer'), 'ausgehender Ressourcen-Transfer'));
	}
