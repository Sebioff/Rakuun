...
class Rakuun_Intern_GUI_Panel_StockMarket_Sell_Iron extends Rakuun_Intern_GUI_Panel_StockMarket {
	...
	public function init() {
		...
		$factor = new GUI_Panel_Number('sell_iron_beryllium', $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_IRON, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_BERYLLIUM)); 
		...
		$factor = new GUI_Panel_Number('sell_iron_energy', $this->calculateStockExchangePrice(Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_IRON, Rakuun_Intern_GUI_Panel_StockMarket::RESSOURCE_ENERGY));
