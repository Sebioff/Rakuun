...
class Rakuun_Intern_Module_StockMarket extends Rakuun_Intern_Module {
	public function init() {
		...
		$this->contentPanel->addPanel(new Rakuun_GUI_Panel_Box('poolbox', new GUI_Panel_Text('pool', $iron->render().' Eisen | '.$beryllium->render().' Beryllium | '.$energy->render().' Energie<br />Heute noch handelbare Ressourcen: '.Rakuun_Intern_GUI_Panel_StockMarket::getTradableLeft()), 'Verfügbare Ressourcen'));
