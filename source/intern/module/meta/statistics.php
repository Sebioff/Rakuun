	...
	public function init() {
		...
		foreach ($alliances as $alliance) {
			$panels[] = array(
				...
				'ressources' => new Rakuun_GUI_Panel_Box('ressources-'.$alliance->getPK(), new Rakuun_Intern_GUI_Panel_Alliance_Statistic_Ressources('ressources', $alliance), 'Rohstoffübersicht'),
				'army' => new Rakuun_GUI_Panel_Box('army-'.$alliance->getPK(), new Rakuun_Intern_GUI_Panel_Alliance_Statistic_Army('army', $alliance), 'Armeeübersicht')
			);
		}
